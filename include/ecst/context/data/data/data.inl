...
namespace ecst::context::impl
{
    ...
    auto data<TSettings>::step(TFStep&& f_step, TFsRefresh&&... fs_refresh)
    {
        ...
        auto refresh_event_handler =
            bh::overload_linearly(FWD(fs_refresh)..., ecst::impl::do_nothing);
        ...
        TRefreshState& rs, TFRefresh&&)
    {
        ...
        this->for_stateful_instances_sequential([&defer_proxy](auto& instance) {
