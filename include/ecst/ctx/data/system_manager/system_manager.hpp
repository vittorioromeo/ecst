...
#include <ecst/ctx/scheduler.hpp>
#include <ecst/ctx/storage.hpp>
...
namespace ecst::ctx::impl
{
    // TODO:
    // Kind aliases.
    constexpr auto k_stateless = sig::system::impl::kind::stateless;
    constexpr auto k_stateful = sig::system::impl::kind::stateful;
    constexpr auto k_entity = sig::system::impl::kind::entity;
    ...
    public:
        ...
        using system_storage_type = // .
            ctx::storage::system::dispatch<settings_type>;
    ...
    public:
        ...
        // TODO:
        constexpr auto inner_par_allowed() const noexcept;
    };
} // namespace ecst::ctx::impl
