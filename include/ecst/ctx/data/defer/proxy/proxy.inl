...
namespace ecst::ctx::impl::defer
{
    ...
    template <typename TSettings>
    template <typename TComponentTag>
    auto proxy<TSettings>::has_component(TComponentTag ct, entity_id eid) const
        noexcept
    {
    ...
    auto& ECST_PURE_FN proxy<TSettings>::instance(TSystemTag st) noexcept
    {
    ...
    decltype(auto) proxy<TSettings>::for_system_outputs(TSystemTag st, TF&& f)
    {
    ...
    template <typename TSettings>
    template <typename TSystemTag>
    auto proxy<TSettings>::is_in_system(TSystemTag st, entity_id eid) const
        noexcept
    {
    ...
    template <typename TSettings>
    template <typename TSystemTag>
    auto proxy<TSettings>::count_entities_in(TSystemTag st) const noexcept
    {
