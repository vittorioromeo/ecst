...
namespace ecst::ctx::system::impl::state_manager
{
    ...
    public:
        ...
        using system_sig_type = TSystemSignature;
        using state_storage_type = // .
            state_storage<settings_type, system_sig_type>;

        static constexpr sz_t max_subtask_count() noexcept
        {
            return 16;
        }
